    ...
    <div class="max-w-[768px] mx-auto h-full overflow-auto">
      ...
      <div class="group relative bg-white">
        ...
        <div class="absolute top-2 right-2">
          <button
            v-if="!coverImageSrc"
            class="bg-gray-100 hover:bg-gray-200 text-gray-800 py-1 px-2 text-xs flex items-center opacity-0 group-hover:opacity-100"
          >
            <svg
          ...
          <div v-else class="flex gap-2">
            <button
              ...
              class="bg-red-700 hover:bg-red-800 text-white py-1 px-2 text-xs flex items-center"
            >
        ...
        <div class="flex">
          ...
          >
            <img
              ...
              class="w-full h-full object-cover rounded-full object-cover"
            />
            <button
              v-if="!avatarImageSrc"
              class="absolute left-0 top-0 bottom-0 right-0 bg-black/25 rounded-full flex items-center justify-center opacity-0 group-hover/avatar:opacity-100"
            >
            ...
            <div v-else class="absolute top-1 right-0 flex flex-col gap-2">
              <button
                ...
                class="w-7 h-7 flex items-center justify-center bg-red-500/80 rounded-full text-white"
              >
                <XMarkIcon class="h-5 w-5" />
              </button>
              <button
                @click="submitAvatarImage"
                class="w-7 h-7 flex items-center justify-center bg-emerald-500/80 rounded-full text-white"
              >
